...
const OrderScreen = () =>{
    ...
    if(!loading){
        order.itemsPrice = order.orderItems.reduce((acc , currVal)=> acc + currVal.price * currVal.qty , 0);
    }
							...
							<Box>
								{loadingPay ? (
									...
									<PayPalScriptProvider
										options={{
											clientId:
												'ASPiv6ATIdNzmzeAkb2tR4-qjGLq5lLtLAKWqPuJbtcEMlqX9mzCHsES8myGSBiLe4hwXukZ2ZgyGiky',
											components: 'buttons',
										}}>
										<PayPalButtons
